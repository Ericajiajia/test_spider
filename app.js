    ...
    http.get(x, function (res) {     
     ...
     //监听end事件，如果整个网页内容的html都获取完毕，就执行回调函数
        ...
        // console.log(html)
         ...
         var news_item = {
          //获取文章的标题(
            title: $($('div.course-card-content h3')[i]).text(),
         //获取文章发布的时间
            // Time: time,   
         //获取当前文章的url
            link: "http://www.imooc.com/" + $("div.g-banner-box img").attr('href'),
         //获取供稿单位
        ...
        //savedImg($,news_title);    //存储每篇文章的图片及图片标题
             ...
             //下一篇文章的url
        // var nextLink="http://www.imooc.com/" + $("div.g-banner-box img").attr('href');
...
//         var img_src = 'http://www.imooc.com/' + $(this).attr('src'); //获取图片的url
